...
\newcommand{\deptName}{Department of nameOfTheDepartment}
\newcommand{\deptNameShort}{ABC}


\newcommand{\examName}{B.Sc. Honours Fourth Year, Second Semester Final Examination-20**}
\newcommand{\courseCode}{ABC~**********}
\newcommand{\courseTitle}{theCourseTitle}
\newcommand{\SessionExaminee}{20**-20**}
